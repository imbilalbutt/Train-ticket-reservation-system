...
* [Rest Repositories](https://docs.spring.io/spring-boot/docs/2.5.11/reference/htmlsingle/#howto-use-exposing-spring-data-repositories-rest-endpoint)
...
* [Spring for RabbitMQ](https://docs.spring.io/spring-boot/docs/2.5.11/reference/htmlsingle/#boot-features-amqp)
